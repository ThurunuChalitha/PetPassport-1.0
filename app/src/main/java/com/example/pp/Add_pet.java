...
public class Add_pet extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText ePet_name,eGender,eBreed,eRemarks;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btPet_reg=(Button)findViewById(R.id.btn_adpet);
    ...
    private void petRegister(){
        ...
        PetData petdata =new PetData(pet_name,gender,breed,remarks);
        ref.child(user.getUid()).setValue(petdata);
